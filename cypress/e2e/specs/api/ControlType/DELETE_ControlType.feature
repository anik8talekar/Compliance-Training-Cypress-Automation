Feature: DELETE Control Type
     ...
     Scenario: Verify Valid Status Code
        ...
        And I save response of request in "ControlType/controlTypePostResponse.json" file
        Then I make DELETE Request with url: "apiBaseUrl" , path: "pathControlType", requestFile: "ControlType/controlTypePostResponse.json"
