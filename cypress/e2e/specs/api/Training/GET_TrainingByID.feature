Feature: GET Training by ID

    Scenario Outline: Verify Valid Status Code
        Given I am authenticated user
        When I make a GET request with url: "apiBaseUrl", path: "pathTraining", query: "<parameter>"
    ...
    Scenario: Verify Response Time
        Given I am authenticated user
        When I make a GET request with url: "apiBaseUrl", path: "pathTraining", query: ""
