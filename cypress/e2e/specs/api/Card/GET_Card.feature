Feature: GET Card
    ...
    Scenario: Verify Valid Status Code
        ...
        When I make a GET request with url: "apiBaseUrl", path: "pathCard", query: "?page=1&pageSize=1&name=string"
    ...
    Scenario: Verify Invalid Status Code
        Given I am authenticated user
        When I make a GET request with url: "apiBaseUrl", path: "pathCard", query: "?page=0&pageSize=0&name=string"
