...
#         When I make a POST request with url: "apiBaseUrl" , path: "pathCard", requestFile: "Content/contentPostRequest.json"
#         And I save response of request in "Content/contentPostResponse.json" file
#         Then I make DELETE Request with url: "apiBaseUrl" , path: "pathCard", requestFile: "Content/contentPostResponse.json"
