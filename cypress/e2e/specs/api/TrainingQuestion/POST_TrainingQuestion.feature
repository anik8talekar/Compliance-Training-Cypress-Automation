Feature: POST Training Question
    ...
    Scenario: Verify Invalid Status Code
        Given I am authenticated user
        When I make a POST request with url: "apiBaseUrl" , path: "pathfalse", requestFile: "TrainingQuestion/trainingQuestionPostRequest.json"
