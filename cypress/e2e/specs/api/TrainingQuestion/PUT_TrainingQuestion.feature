Feature: PUT Training Question API

 Scenario: Verify Valid Status Code
 Given I am authenticated user
 When I make a PUT request with url: "apiBaseUrl" , path: "pathTrainingQuestion", requestFile: "TrainingQuestion/trainingQuestionPutRequest.json", readFile: "TrainingQuestion/trainingQuestionPostResponse.json"
 Then I save response of request in "TrainingQuestion/trainingQuestionPutResponse.json" file
...
    #     Then I validate the response using data from "trainingAPIFixtures" and file "training"
 ...
 Given I am authenticated user
 When I make a PUT request with url: "apiBaseUrl" , path: "pathfalse", requestFile: "TrainingQuestion/trainingQuestionPutRequest.json", readFile: "TrainingQuestion/trainingQuestionPostResponse.json"
