Feature: GET Content
    ...
    Scenario: Verify Valid Status Code
        ...
        When I make a GET request with url: "apiBaseUrl", path: "pathContent", query: "?page=1&pageSize=1"
    ...
    Scenario: Verify Invalid Status Code
        Given I am authenticated user
        When I make a GET request with url: "apiBaseUrl", path: "pathContent", query: "?page=0&pageSize=0"
